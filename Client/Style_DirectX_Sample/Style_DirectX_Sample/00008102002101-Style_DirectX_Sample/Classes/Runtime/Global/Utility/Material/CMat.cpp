...
{
	m_pEffect = GET_MANAGER_D3D_RES()->GetEffect(m_oPath_Effect);
	m_pInputLayout = GET_MANAGER_D3D_RES()->GetInputLayout(m_oPath_Effect);
}

void CMat::EnumeratePasses(int a_nIdx_Technique, 
